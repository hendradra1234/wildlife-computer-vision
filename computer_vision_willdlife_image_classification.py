...
def recreate_labels(datapath):
    labels = [folder for folder in os.listdir(train_path) if not folder.startswith('.')]
...
tf.saved_model.save(model, models_save)
...
recreate_labels(models_save_tflite_label)
